...
declare const FS: {
  ...
  readonly copy: (
    fromPath: string,
    toPath: string,
    options?: FileSystem.CopyOptions | undefined
  ) => Effect.Effect<void, PlatformError.PlatformError, FileSystem.FileSystem>;
  readonly copyFile: (
    fromPath: string,
    toPath: string
  ...
  readonly makeTempDirectory: (
    options?: FileSystem.MakeTempDirectoryOptions | undefined
  ) => Effect.Effect<string, PlatformError.PlatformError, FileSystem.FileSystem>;
  readonly makeTempDirectoryScoped: (
    options?: FileSystem.MakeTempDirectoryOptions | undefined
  ) => Effect.Effect<string, PlatformError.PlatformError, FileSystem.FileSystem | import('effect/Scope').Scope>;
  readonly makeTempFile: (
    options?: FileSystem.MakeTempFileOptions | undefined
  ) => Effect.Effect<string, PlatformError.PlatformError, FileSystem.FileSystem>;
  ...
  readonly open: (
    path: string,
    options?: FileSystem.OpenFileOptions | undefined
  ) => Effect.Effect<
    FileSystem.File,
    PlatformError.PlatformError,
    FileSystem.FileSystem | import('effect/Scope').Scope
  >;
  ...
  readonly remove: (
    path: string,
    options?: FileSystem.RemoveOptions | undefined
  ) => Effect.Effect<void, PlatformError.PlatformError, FileSystem.FileSystem>;
  readonly rename: (
    oldPath: string,
    newPath: string
  ...
  readonly stat: (
    path: string
  ) => Effect.Effect<FileSystem.File.Info, PlatformError.PlatformError, FileSystem.FileSystem>;
  readonly symlink: (
    fromPath: string,
    toPath: string
  ) => Effect.Effect<void, PlatformError.PlatformError, FileSystem.FileSystem>;
  readonly truncate: (
    path: string,
    length?: FileSystem.SizeInput | undefined
  ) => Effect.Effect<void, PlatformError.PlatformError, FileSystem.FileSystem>;
  readonly utimes: (
    path: string,
    atime: number | Date,
  ...
  readonly writeFile: (
    path: string,
    data: Uint8Array,
    options?: FileSystem.WriteFileOptions | undefined
  ) => Effect.Effect<void, PlatformError.PlatformError, FileSystem.FileSystem>;
  readonly writeFileString: (
    path: string,
    data: string,
    options?: FileSystem.WriteFileStringOptions | undefined
  ) => Effect.Effect<void, PlatformError.PlatformError, FileSystem.FileSystem>;
};
...
export declare const makeTempPathScoped: (
  dirName: string
) => Effect.Effect<string, PlatformError.PlatformError, FileSystem.FileSystem | import('effect/Scope').Scope>;
